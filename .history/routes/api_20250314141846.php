...
Route::get('/favorite_sources/fetch', [FavoriteSourceController::class, 'fecth']);
...
Route::get('/settings/statistics', function () {
    $statistics = [
        'total_rss_feeds' => RssFeedModel::count(),
        'total_ready_feeds' => ReadyFeed::count(),
        'total_favorite_sources' => FavoriteSource::count(),
