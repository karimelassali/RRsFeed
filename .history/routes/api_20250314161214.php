...
Route::middleware(['auth.api:sanctum'])->group(function () {
    ...
    Route::post('settings/setApiKey',[AuthController::class,'setApiKey'])->middleware('auth:sanctum');
});
...
Route::get('/favorite_sources/fetch', [FavoriteSourceController::class, 'fecth'])->middleware('auth:sanctum');
Route::delete('favorite-sources/{id}', [FavoriteSourceController::class, 'destroy']);
...
Route::get('/settings/statistics', [AuthController::class, 'getStatistics'])->middleware('auth:sanctum');
...
Route::delete('articles/{id}', [DataController::class, 'destroy'])->middleware('auth:sanctum');