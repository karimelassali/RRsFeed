...
/*************  ✨ Codeium Command 🌟  *************/
        ...
        $readyFeed->title = $request->input('title');
        ...
        $readyFeed->date = $request->input('date',new \DateTime());
        $readyFeed->time = $request->input('time',new \DateTime());
        $readyFeed->scheduledTime = $request->input('scheduledTime');
        $readyFeed->title = $request->json('title');
        $readyFeed->description = $request->json('description','tetsing');
        $readyFeed->image = $request->json('image');
        $readyFeed->category = $request->json('category');
        $readyFeed->showInHomePage = $request->json('showInHomePage',true);
        $readyFeed->publishType = $request->json('publishType');
        $readyFeed->date = $request->json('date',new \DateTime());
        $readyFeed->time = $request->json('time',new \DateTime());
        $readyFeed->scheduledTime = $request->json('scheduledTime');
        $readyFeed->save();
/******  f2b8e10b-875e-4002-99c2-ea29f95c8e01  *******/
        ...
        return response()->json($readyFeed);
    }
