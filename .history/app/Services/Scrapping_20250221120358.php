                    ...
                    try {
                        ...
                        try {
                            if(str_contains($sourceUrl,'appweb.regione.vda.it')){
                                ...
                                $description = $this->extractContent($itemContentCrawler,'.c')
                                $title && $crawler ? Log::info('desc for the new source '.$description) : Log::error('Error to fetching data in new feed ');
                            }
