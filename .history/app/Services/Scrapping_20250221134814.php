            ...
            try {
                ...
                foreach ($crawler->filter('item') as $item) {
                    try {
                        ...
                        try {
                            [2025-02-21 12:47:06] local.ERROR: Error extracting content from https://appweb.regione.vda.it/dbweb/Comunicati.nsf/VediNewsi/A0CC22A09FDC8972C1258C360054E174?OpenDocument: The current node list is empty.
