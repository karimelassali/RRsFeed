                        ...
                        try {
                            if (str_contains($sourceUrl, 'appweb.regione.vda.it')) {
                                try {
                                    ...
                                    $description = $this->extractContent($itemContentCrawler, 'table.noborder p:first-child');
                                    if ($title && $description) {
                                        Log::info('desc for the new source ' . $description);
                                    } else {
                                        Log::error('Error fetching data in new feed');
                                    }
                                } catch (\Exception $e) {
