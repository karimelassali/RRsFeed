            ...
            try {
                ...
                foreach ($crawler->filter('item') as $item) {
                    try {
                        ...
                        try {
                            if(str_contains($sourceUrl,'regione.vda.it')){
                                $title = $this->extractContent($itemContentCrawler,' if(str_contains($sourceUrl,'regione.vda.it')){
                                    $title = $this->extractContent($itemContentCrawler,'')
                                }');
                            }
